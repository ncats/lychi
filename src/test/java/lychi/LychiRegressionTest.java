...
public class LychiRegressionTest {
    ...
    public static List<Object[]> data(){
        ...
        tests.add(LychiTestInstance.of("O=C(O[C@H]1C[C@H]2C[C@H]3C[C@@H](C1)N2CC3=O)C4=CNC5=C4C=CC=C5","38C4U16JU-UH6CFSN8RB-UBLCKYUP1CU-UBUYYPQ4TKS3").name("cage-like structure"));
